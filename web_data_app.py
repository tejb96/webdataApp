...
@app.route("/learn")
def learn():
    return "I learned that once the code gets messy, it can be difficult to go back and clean it up, so it is important to keep it clean every step of the way."
